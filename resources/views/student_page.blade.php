...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4" id="avatar">
            <img class="img-responsive img-rounded" src="{{ Storage::url('/avatars/user.png') }}"/>
        </div>
        <div class="col-md-7" id="account_info">
            ...
            <div class="update_and_save">
                ...
                <h5 id="h2_2"><span><a id="save-account-info" href="" ><i class="fa fa-floppy-o fa-lg" aria-hidden="true"></i> Save changes</a></span></h5>
            </div>
            <div class="info">
